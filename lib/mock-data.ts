...
export const mockTools: Tool[] = [
  ...
  // Web Hosting niche
  {
    ...
    name: "Hostinger",
    slug: "hostinger",
    tagline: "Affordable shared and VPS hosting",
    description: "Budget-friendly web hosting with solid performance, free SSL, and 24/7 support. Popular for small sites and WordPress.",
    logo_url: null,
    ...
    sponsored_tier: null,
    features: {},
    pros: ["Low price", "Good uptime", "Free SSL & migration"],
    cons: ["Support can be slow"],
    best_for: ["Starter sites", "WordPress", "Portfolios"],
